      ...
      <div className="flex h-[calc(100vh-85px)]">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="h-[55%] bg-white border-b border-gray-200">
            <div 
              className={`h-full bg-[#F8F9FA] flex items-center justify-center relative transition-all duration-300 ${
                ...
                try {
                  ...
                  if (assetData) {
                    ...
                    if (!pendingModels.has(modelName)) {
                      ...
                      setCurrentModelUrl(asset.glb_link);
                      setSelectedVariants([]);
                      // Add to selectedAssets if not already there
                      setSelectedAssets(prev => {
                        const exists = prev.some(a => a.id === asset.id);
            ...
            >
              {/* Drag Overlay */}
              {isDragging && (
                <div className="absolute inset-0 flex items-center justify-center bg-primary/10 border-2 border-dashed border-primary rounded-lg z-10 backdrop-blur-sm">
              ...
              {!selectedModel && !isDragging && (
                <div className="text-gray-400 text-center">
                  ...
                  <p className="text-sm text-gray-500 max-w-xs">
                    Choose a model from the sidebar or drag and drop to preview and configure render settings
                  </p>
                </div>
              )}
            </div>
