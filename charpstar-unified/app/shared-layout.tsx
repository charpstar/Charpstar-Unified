...
export function SharedLayout({ children }: { children: React.ReactNode }) {
  ...
  const mainContentClass = [
    "flex-1 flex flex-col min-h-screen w-full overflow-x-hidden p-4 scrollbar-hide ",
    !hideSidebar && " bg-[#606d64] ",
  ]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    <div className="flex min-h-screen w-full bg-background rounded-lg">
      ...
      <div className={mainContentClass}>
        ...
        <div className="flex-1 overflow-y-auto rounded-b-lg justify-center items-center h-full max-h-[calc(100vh-50px)] scrollbar-y-hide relative inset-[2px shadow-2xl shadow-black/20]">
