...
export function TableSkeleton() {
  return (
    <div
      role="status"
      className="p-4 border w-full h-full border-border   rounded-lg shadow animate-pulse md:p-6 dark:border-border  dark:bg-background"
    >
      {/* Header row */}
      <div className="flex gap-4 mb-4 w-full">
        <div className="h-8 w-full bg-gray-100 rounded-lg dark:bg-muted"></div>
        <div className="h-8 w-full bg-gray-100 rounded-lg dark:bg-muted"></div>
        <div className="h-8 w-full bg-gray-100 rounded-lg dark:bg-muted"></div>
        <div className="h-8 w-full bg-gray-100 rounded-lg dark:bg-muted"></div>
        <div className="h-8 w-full bg-gray-100 rounded-lg dark:bg-muted"></div>
