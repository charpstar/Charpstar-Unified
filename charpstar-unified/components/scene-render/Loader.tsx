...
const messages = [
  "Conceptualizing 5 unique environments...",
  "Setting up 5 virtual photoshoots...",
  "Rendering multiple lighting scenarios...",
  "Applying photorealistic details to each scene...",
  "Compiling your product gallery...",
];
