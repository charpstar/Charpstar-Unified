...
export default function ModularAssetPanel({
  ...
  const itemsPerPage = 100; // Show 100 assets per page to fill vertical space
                ...
                {paginatedAssets.map((asset) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "group relative text-left border bg-gradient-to-br from-card to-card/50 hover:from-card hover:to-card transition-all duration-300 overflow-hidden hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] w-[calc(25%-9px)] cursor-grab active:cursor-grabbing",
                        isSelected
