...
const ResultDisplay: React.FC<ResultDisplayProps> = ({
  ...
  const handleDownloadOriginal = async () => {
    try {
      ...
      link.href = url;
      link.download = `product-render-original-${Date.now()}.png`;
      ...
      toast.success("Original product render downloaded successfully!");
    } catch (error) {
  ...
  const handleDownloadUpscaled = async () => {
    try {
      if (upscaledImageUrl) {
        ...
        const link = document.createElement("a");
        link.href = url;
        link.download = `product-render-upscaled-${Date.now()}.png`;
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
        ...
        toast.success("Upscaled product render downloaded successfully!");
      } else {
          ...
          <div className="w-full max-w-4xl mb-6 flex-1 min-h-0 overflow-hidden">
            ...
            >
              ...
              <Image
                ...
                alt="AI upscaled product render"
        ...
        >
          ...
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            <Image
              ...
              alt="AI upscaled product render in fullscreen"
